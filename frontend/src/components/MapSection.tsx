...
export default function MapSection() {
    ...
    // Get status color
    const getStatusColor = (status: Trend) => {
        switch (status) {
            case 'up':
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    ...
                    <p className="text-gray-600 dark:text-gray-400">
                        Klik provincia untuk melihat prediksi harga minggu depan
                    </p>
                </div>
                ...
                {/* Map */}
                <div className="mb-8">
                    <div className="h-[500px] rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-700 shadow-lg">
                        <MapContainer
                            center={[-5, 115]}
                            zoom={5}
                            minZoom={5}
                ...
                <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700">
                    <div className="flex items-center mb-6">
                        <Info size={24} className="text-green-600 mr-3" />
                    ...
                    {isLoading ? (
                        ...
                        <div className="text-gray-500 text-center py-4">Tidak ada data harga</div>
                    ) : (
                                    ...
                                    <div className="flex justify-between items-center">
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-500">
                                                Rp {commodity.price.toLocaleString('id-ID')}{commodity.unit}
                                            </p>
                                        </div>
                                        <div className={`flex items-center ${getStatusColor(commodity.status)}`}>
